...
function List({coin}) {
  ...
  return (
   <>
    <div className="flex justify-center items-center  bg-gray-900 rounded-xl mt-3 ">
                <div className="flex h-60 w-full bg-gray-800 rounded-xl p-6 transition-all duration-300 hover:shadow-lg hover:shadow-green-300/20 hover:border-green-300 border-2 border-transparent gap-32">
                    ...
                    {coin.price_change_percentage_24h >0 ? (<h3 className="text-green-500 text-3xl font-bold pt-16">${coin.current_price}</h3>):
                    (<h3 className="text-red-500 text-3xl font-bold pt-16">${coin.current_price}</h3>)}
                    
                    <div className=" flex text-blue-300 text-lg  font-bold  items-center gap-14">
